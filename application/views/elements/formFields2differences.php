...
<div class="form-group">
    <label for="inputEmail">Difference 1 (for All the days except last and 2nd last day)</label>
    <input type="number" step="any" class="form-control" name="difference_1" placeholder="difference" required>
</div>
<div class="form-group">
    <label for="inputEmail">Difference 2 (for only the last and 2nd last day.)</label>
    <input type="number" step="any" class="form-control" name="difference_2" placeholder="difference" required>
</div>
<div class="form-group">
